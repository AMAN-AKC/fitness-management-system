...
public class GlobalExceptionHandlerTest {
    ...
    void handleDuplicateResource() {
        ...
        ResponseEntity<Map<String, Object>> response = exceptionHandler.handleDuplicateResource(ex, request);
    ...
    void handleUnauthorized() {
        ...
        ResponseEntity<Map<String, Object>> response = exceptionHandler.handleUnauthorized(ex, request);
    ...
    void handleValidationErrors() throws NoSuchMethodException {
        ...
        assertTrue(((Map<String, String>) response.getBody().get("fieldErrors")).containsKey("field"));
    }
    ...
    void handleBusinessRule() {
        BusinessRuleException ex = new BusinessRuleException("Business error");
    ...
    void handleBadCredentials() {
        ...
        ResponseEntity<Map<String, Object>> response = exceptionHandler.handleBadCredentials(ex, request);
    ...
    void handleLocked() {
        ...
        ResponseEntity<Map<String, Object>> response = exceptionHandler.handleLocked(ex, request);
        assertEquals(HttpStatus.UNAUTHORIZED, response.getStatusCode());
    }
