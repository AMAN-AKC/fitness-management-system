...
@Component
public class CashPaymentGatewayProcessor implements PaymentGatewayProcessor {

	@Override
	public boolean supports(Payment.PaymentMethod method) {
		return method == Payment.PaymentMethod.CASH;
	}
	...
	public PaymentProcessingResult process(PaymentDTO paymentDTO, Invoice invoice, Member member) {
		return PaymentProcessingResult.builder()
				...
				.gatewayReference("CASH-" + invoice.getInvoiceNumber() + "-" + member.getMemberId())
				.build();
	}
}